package
{
   ...
   public class PipboyUpdateMask
   {
      ...
      public function PipboyUpdateMask(param1:uint) { super(); this._Mask = param1; }
      public function Contains(param1:PipboyUpdateMask):Boolean { return (this._Mask & param1._Mask) == param1._Mask; }
      public function Intersects(param1:PipboyUpdateMask):Boolean { return (this._Mask & param1._Mask) > 0; }
   }
}
